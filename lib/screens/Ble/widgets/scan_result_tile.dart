...
class _ScanResultTileState extends State<ScanResultTile> {
  ...
  Widget build(BuildContext context) {
    ...
    bool isDeviceInCloud =
        dbService.allDevices.any((device) => device.mac == adv.localName);
    if (isDeviceInCloud) {
      return ExpansionTile(
        ...
        children: <Widget>[
          ...
          _buildAdvRow(
              context, 'Tx Power Level', '${adv.txPowerLevel ?? 'N/A'}'),
      ...
      // Return an empty container if the device is not in the cloud
      return Container();
    }
  }
}
